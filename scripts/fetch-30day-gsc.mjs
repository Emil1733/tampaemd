...
async function run() {
  const outputDir = path.join(process.cwd(), 'gsc', '06-20-2026');
  ...
  try {
    // Current 30 days: 2026-05-21 to 2026-06-19
    const currentData = await fetchGscData('2026-05-21', '2026-06-19', 'current');
    
    // Previous 30 days: 2026-04-21 to 2026-05-20
    const previousData = await fetchGscData('2026-04-21', '2026-05-20', 'previous');
